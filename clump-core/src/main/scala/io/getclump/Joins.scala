...
protected[getclump] trait Joins {
  ...
  /**
    ...
    */
  def join[A, B, C, D, E, F](a: Clump[A],
                             b: Clump[B],
                             c: Clump[C],
                             d: Clump[D],
                             e: Clump[E],
                             f: Clump[F]): Clump[(A, B, C, D, E, F)] =
  ...
  /**
    ...
    */
  def join[A, B, C, D, E, F, G](a: Clump[A],
                                b: Clump[B],
                                c: Clump[C],
                                d: Clump[D],
                                e: Clump[E],
                                f: Clump[F],
                                g: Clump[G]): Clump[(A, B, C, D, E, F, G)] =
  ...
  /**
    ...
    */
  def join[A, B, C, D, E, F, G, H](a: Clump[A],
                                   b: Clump[B],
                                   c: Clump[C],
                                   d: Clump[D],
                                   e: Clump[E],
                                   f: Clump[F],
                                   g: Clump[G],
                                   h: Clump[H]): Clump[(A, B, C, D, E, F, G, H)] =
  ...
  /**
    ...
    */
  def join[A, B, C, D, E, F, G, H, I](a: Clump[A],
                                      b: Clump[B],
                                      c: Clump[C],
                                      d: Clump[D],
                                      e: Clump[E],
                                      ...
                                      g: Clump[G],
                                      h: Clump[H],
                                      i: Clump[I]): Clump[(A, B, C, D, E, F, G, H, I)] =
  ...
  /**
    ...
    */
  def join[A, B, C, D, E, F, G, H, I, J](a: Clump[A],
                                         b: Clump[B],
                                         c: Clump[C],
                                         d: Clump[D],
                                         e: Clump[E],
                                         ...
                                         h: Clump[H],
                                         i: Clump[I],
                                         j: Clump[J]): Clump[(A, B, C, D, E, F, G, H, I, J)] =
